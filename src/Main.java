			...
			if ((usuarioLogado.getSenha().equals(senha))) {
				...
				if (usuarioLogado.IsEmpresa()) {
					...
					case 1: {
						...
						do {
							...
							for (Produto produtoSearch : produtos) {
								// garante que o produto escolhido pertence a empresa escolhida
					...
					case 1: {
						...
						empresas.stream().forEach(x -> {
							System.out.println("************************************************************");
							System.out.println("Código: " + x.getId());
							System.out.println("Nome: " + x.getNome());
							System.out.println("CNPJ: " + x.getCnpj());
							System.out.println("Taxa: " + x.getTaxa());
					...
					case 3: {
						...
						produtos.stream().forEach(x -> {
							...
							System.out.println("Código: " + x.getId());
							System.out.println("Nome: " + x.getNome());
							System.out.println("Quantidade em estoque: " + x.getQuantidade());
							System.out.println("Valor: " + x.getPreco());
							System.out.println("Empresa: " + x.getEmpresa().getNome());
							System.out.println("************************************************************");
						});
						System.out.println("************************************************************");
						executar(usuarios, clientes, empresas, produtos, carrinho, vendas);
